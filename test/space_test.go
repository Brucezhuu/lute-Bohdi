...
var spaceTests = []parseTest{
	...
	// 汉语拼音中文空格问题 https://github.com/Brucezhuu/lute-Bohdi/issues/86
	{"37", "中yā文", "<p>中 yā 文</p>\n"},

	// 井号 # 前后自动空格问题 https://github.com/Brucezhuu/lute-Bohdi/issues/62
	{"36", "前#foo", "<p>前#foo</p>\n"},
	{"35", "foo#后", "<p>foo#后</p>\n"},
	{"34", "foo#bar", "<p>foo#bar</p>\n"},
	{"33", "前#后", "<p>前#后</p>\n"},

	// 加粗、强调和删除线自动空格改进 https://github.com/Brucezhuu/lute-Bohdi/issues/25
	...
	// 链接前后自动空格改进 https://github.com/Brucezhuu/lute-Bohdi/issues/24
	...
	// ing 前不需要空格，如 打码ing https://github.com/Brucezhuu/lute-Bohdi/issues/9
